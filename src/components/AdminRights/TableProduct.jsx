    ...
    return (
        <div>
            <section className=" dark:bg-gray-900 p-3 sm:p-5 antialiased">
                <p className=' font-bold text-6xl text-yellow-500  text-center my-12'>Vendor Panel</p>
                        ...
                        <div className="  flex flex-col md:flex-row items-stretch md:items-center md:space-x-3 space-y-3 md:space-y-0 justify-between mx-4 py-8  dark:border-gray-700">
                            <div className='w-full  flex items-center  gap-3   '>
                                ...
                                <button
                                    ...
                                    className="flex items-center justify-center gap-2   bg-blue-500 text-white font-bold focus:ring-2 focus:ring-primary-300  transition-all ease-in rounded-md text-sm px-4 py-2 dark:bg-yellow-600 dark:hover:bg-yellow-700 focus:outline-none dark:focus:ring-primary-800"
                                >
