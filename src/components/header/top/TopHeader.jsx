        ...
        <div>
            <main className=" flex md:justify-between justify-center gap-4 items-center list-none md:py-5 py-3 text-sm select-none">
                ...
                {isLoggedIn == "true" && <li className=" flex gap-4 justify-center items-center ">
                    <ul className='  cursor-pointer px-5 py-2 font-bold rounded-full text-white bg-blue-700 hover:bg-blue-800 ' onClick={() => Navigate("/admin-account")}>Admin account</ul>
                    <ul className='  cursor-pointer px-5 py-2 font-bold rounded-full text-white bg-blue-700 hover:bg-blue-800 ' onClick={() => Navigate("/background-remove")}>Remove BG</ul>
                    ...
                    <ul className='  cursor-pointer px-5 py-2 font-bold rounded-full text-white bg-blue-700 hover:bg-blue-800 ' onClick={() => Navigate("/uploadcare")}> Uploadcare</ul>
                </li>}
