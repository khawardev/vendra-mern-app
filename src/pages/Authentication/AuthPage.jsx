            ...
            <form onSubmit={handleSubmit} className="md:border rounded-lg  w-full  py-16  h-[600px]   md:px-12">
                ...
                <p className="text-center text-gray-500 text-sm mb-10 select-none">
                    <span className="font-extrabold flex justify-center items-center gap-1">
                        <span>
                            <span
                                className={`text-lg cursor-pointer  px-3 py-1 ${isRegistering ? 'text-gray-300' : 'text-gray-900  border rounded-full px-3 py-1'}`}
                        ...
                        <span>
                            <span
                                className={`text-lg cursor-pointer  px-3 py-1 ${isRegistering ? 'text-gray-900  border rounded-full px-3 py-1' : 'text-gray-300'}`}
