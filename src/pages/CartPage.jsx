                                        ...
                                        <tr key={cartItems.id} className=" select-none">
                                            ...
                                            <td className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <div className="flex items-center font-bold   text-gray-500">
                                                    {/* ${cartItems?.price} */}
                                                    <p><span className=' text-xs'>{ExchangeRate ? ExchangeRate.code : '$'} </span>{ExchangeRate ? (ExchangeRate.value * cartItems.price).toFixed(0) : cartItems.price}</p>
                                                ...
                                                <div className="flex items-center space-x-4">
                                                    <td className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        <div className="flex items-center font-bold   text-gray-500">
                                                            ...
                                                            <p><span className=' text-xs'>{ExchangeRate ? ExchangeRate.code : '$'} </span>{ExchangeRate ? (ExchangeRate.value * cartItems?.price * cartItems.quantity).toFixed(0) : (cartItems?.price * cartItems.quantity).toFixed(2)}</p>
                            ...
                            <div className=' p-8  border-2 border-black rounded-md w-[600px]   '>
                                ...
                                <main className=' '>
                                    ...
                                    <main className='my-3 flex justify-between items-center'>
                                        ...
                                        <p><span className=' text-xs'>{ExchangeRate ? ExchangeRate.code : '$'} </span>{ExchangeRate ? (ExchangeRate.value * totalSubtotal).toFixed(2) : totalSubtotal.toFixed(2)}</p>
                                        ...
                                        {cartItems?.map((cartItems, index) => (
                                            <div key={cartItems.id}>
                                                <main className='my-3 flex justify-between items-center'>
                                                    ...
                                                    <p className=' text-gray-500'><span className=' text-xs'>{ExchangeRate ? ExchangeRate.code : '$'} </span>{ExchangeRate ? (ExchangeRate.value * cartItems.price).toFixed(0) : cartItems.price.toFixed(0)}</p>
                                                </main>
                                            </div>
                                        ))}
                                    </main>
                                    ...
                                    <main className=' flex justify-between items-center '>
                                        ...
                                        <p className=' font-bold   text-xl  '><span className=' text-xs'>{ExchangeRate ? ExchangeRate.code : '$'} </span> {discountApplied ? `${ExchangeRate ? (ExchangeRate.value * (totalSubtotal - (totalSubtotal * 0.1))).toFixed(0) : totalSubtotal - (totalSubtotal * 0.1).toFixed(2)}  ` : `${ExchangeRate ? (ExchangeRate.value * totalSubtotal).toFixed(0) : totalSubtotal}`}</p>
