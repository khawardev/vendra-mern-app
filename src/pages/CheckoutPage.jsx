...
import StripePayment from '../components/StripePaymentForm'; // Import the new StripePayment component
        ...
        <div className=' col-span-2'>
          ...
          <form id="checkoutForm" onSubmit={handleSubmit}>
            ...
            <div className="radio-group">
              <label className=' font-bold text-xl text-gray-700 mb-5 '>Payment Method</label>
              <div className="radio-option">
                ...
                />
                <label htmlFor="cod">
                  <CiDeliveryTruck className=' inline text-xl' />
                  Cash on Delivery
                </label>
              </div>
              <div className="radio-option">
                ...
                />
                <label htmlFor="card">
                  <BsCreditCard2Front className=' inline text-xl' />
                  Debit/Credit Card
                </label>
              </div>
            </div>
            ...
            {showPaymentCARD && (
              <Elements stripe={stripePromise}>
                <StripePayment onSuccessfulPayment={handleSuccessfulPayment} />
              </Elements>
            )}

            {showPaymentCOD && (
              <div className=' mt-10'>
                <p className=' text-lg text-gray-500'>You selected Cash on Delivery. Please make sure you have the exact amount ready.</p>
              </div>
            )}
            ...
            <div className="radio-group">
              <label className=' font-bold text-xl text-gray-700 mb-5 '>Terms and Conditions</label>
              <div className="radio-option">
                <input
                  type="radio"
                  id="agree"
            ...
            <button type="submit" className=' mt-10 w-full bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline'>
              Place Order
            </button>
          </form>
        </div>

        <div className="checkout-summary col-span-1">
